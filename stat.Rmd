...
#s.test(group_CD$ValueB, honestvalues, alternative = "less", simulate=TRUE, B=10000)

# qqplot (ANNA)
# chi-square (JUDIT)
# ks.test: ugy, ahogy ok csinaltak - BIZTOSAN IGY CSINALTAK?
...
_AZ ELSO LESS/GRETAER, MINT A MASODIK; LEGYEN MIND ONE-SIDED_
