...
We have excluded `r nbof_excluded` participants because XXX. We kept recruiting participants until we had 36 in each condition, all in all 144 participants. Their median age was XXX (range XXX - XXX) and XXX were male.

HOL KERDEZZUK MEG A NEMET ES A KORT? HA A ZTREE-BEN, AKKOR BE KÉNE ÍRNI A KÓDBA EZT IS
 
## The distribution of reported numbers 
Figure XXX shows the frequency of value pairs in the four conditions: Higher frequency pairs are darker. 
...
Figure XXX shows the number of doubles reported by all participants as a function of time in each condition.
...
EBBE A TÁBLÁZATBA MEG BELE KENE TENNI A MEDIAN NUMBER OF DOBLES-T, NEM?
