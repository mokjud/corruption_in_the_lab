...
honestvalues <- ecdf(1:5)

ks.test(group_SH$ValueB, honestvalues, alternative = "two.sided")
ks.test(group_SD$ValueB, honestvalues, alternative = "two.sided")
ks.test(group_CH$ValueB, honestvalues, alternative = "two.sided")
ks.test(group_CD$ValueB, honestvalues, alternative = "two.sided")
