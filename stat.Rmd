...
for (i in groups$Condition) {
  ...
  w <- wilcox.test(current$Nbof_doubles, 3.33, alternative = "greater")
  print(w)
}
...
#wilcox.test(participants_group_SH$Nbof_doubles, participants_group_SD$Nbof_doubles, alternative = "less")
#wilcox.test(participants_group_CH$Nbof_doubles, participants_group_CD$Nbof_doubles, alternative = "less")
```
