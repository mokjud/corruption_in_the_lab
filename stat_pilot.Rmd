...
This document contains the results of the pilot data. 
...
The follwowing boxplots show the distribution of the number of doubles in each condition, summed for all rounds of the game.
