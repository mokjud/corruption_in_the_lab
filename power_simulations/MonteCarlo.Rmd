...
seed = 1 # random seed
samplesize = c(3:5,10,20,30:40) # sample sizes to test (the number of participants in each group)
simulations = 100 # the number of simulations with a given sample size
